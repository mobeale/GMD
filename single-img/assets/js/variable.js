...
var _site_bg_overlay_color =                      'rgba(0, 190, 242, 0.8)'; // overlay color, rgba format
...
var _constellation_color =                        'rgb(255, 255, 255)';// [rgba format] - constellation color
var _constellation_width =                        2; // [px] - constellation width

// if _bg_effect == 2 (parallax star)
var _parallax_star_opacity =                      1; // [0.1 to 1] - parallax star opacity

// if _bg_effect == 3 (particles)
var _particles_opacity =                          .8; // [0.1 to 1] - particles opacity
var _particles_link_opacity =                     .7; // [0.1 to 1] - particles link opacity
